...
namespace HermesProxy.World.Server
{
    public partial class WorldSocket
    {
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_PARTY_INVITE);
        ...
        void HandlePartyInviteResponse(PartyInviteResponse invite)
        {
            if (invite.Accept)
            {
                WorldPacket packet = new(Opcode.CMSG_GROUP_ACCEPT);
                if (LegacyVersion.AddedInVersion(ClientVersionBuild.V3_0_2_9056))
                    packet.WriteUInt32(0);
                SendPacketToServer(packet);
            }
            ...
            {
                WorldPacket packet = new(Opcode.CMSG_GROUP_DECLINE);
                SendPacketToServer(packet);
            }
        }
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_GROUP_DISBAND);
            SendPacketToServer(packet);
        }
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_GROUP_UNINVITE_GUID);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_SET_ASSISTANT_LEADER);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_SET_PARTY_LEADER);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_CONVERT_RAID);
            SendPacketToServer(packet);
        }
        ...
        {
            WorldPacket packet = new(Opcode.MSG_RAID_READY_CHECK);
            SendPacketToServer(packet);
        }
        ...
        {
            WorldPacket packet = new(Opcode.MSG_RAID_TARGET_UPDATE);
        ...
        void HandleSummonResponse(SummonResponse update)
        {
            ...
            {
                WorldPacket packet = new(Opcode.CMSG_SUMMON_RESPONSE);
        ...
        {
            WorldPacket packet = new(Opcode.MSG_MINIMAP_PING);
        ...
        {
            WorldPacket packet = new(Opcode.MSG_RANDOM_ROLL);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_GROUP_CHANGE_SUB_GROUP);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_GROUP_SWAP_SUB_GROUP);
