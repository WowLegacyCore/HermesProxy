...
namespace HermesProxy.World.Server
{
    public partial class WorldSocket
    {
        ...
        void HandleTimeSyncResponse(TimeSyncResponse response)
        {
            ...
            {
                WorldPacket packet = new(Opcode.CMSG_TIME_SYNC_RESPONSE);
        ...
        void HandleAreaTrigger(AreaTriggerPkt at)
        {
            ...
            WorldPacket packet = new(Opcode.CMSG_AREA_TRIGGER);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_SET_SELECTION);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_RECLAIM_CORPSE);
        ...
        {
            WorldPacket packet = new(cinematic.GetUniversalOpcode());
            SendPacketToServer(packet);
        }
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_FAR_SIGHT);
        ...
        void HandleTutorialFlag(TutorialSetFlag tutorial)
        {
            switch (tutorial.Action)
            {
                ...
                {
                    WorldPacket packet = new(Opcode.CMSG_TUTORIAL_CLEAR);
                    SendPacketToServer(packet);
                    break;
                }
                case TutorialAction.Reset:
                {
                    WorldPacket packet = new(Opcode.CMSG_TUTORIAL_RESET);
                    SendPacketToServer(packet);
                    break;
                }
        ...
        {
            LFGListUpdateBlacklist blacklist = new();
        ...
        {
            ConquestFormulaConstants response = new()
            {
