...
namespace HermesProxy.World.Server
{
    public partial class WorldSocket
    {
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_LOOT_RELEASE);
        ...
        void HandleLootItem(LootItemPkt loot)
        {
            ...
            {
                WorldPacket packet = new(Opcode.CMSG_AUTOSTORE_LOOT_ITEM);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_LOOT_UNIT);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_LOOT_MONEY);
            SendPacketToServer(packet);
        }
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_SET_LOOT_METHOD);
        ...
        {
            WorldPacket packet = new(Opcode.CMSG_LOOT_ROLL);
        ...
        void HandleLootMasterGive(LootMasterGive loot)
        {
            foreach (var item in loot.Loot)
            {
                WorldPacket packet = new(Opcode.CMSG_LOOT_MASTER_GIVE);
